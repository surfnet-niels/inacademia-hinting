...
ADMIN_DATA_REPO=/tmp/admin_data_repo
...
ln -s $CONFIG_PATH $HINTING_ROOTPATH/hinting/
...
GIT_SSH_COMMAND="ssh -i $CONFIG_PATH/id_rsa_inacademia" /usr/bin/git clone $ADMIN_DATA_REPO $ADMIN_DATA_REPO
cd $ADMIN_DATA_REPO
...
rsync -rtv $HINTING_ROOTPATH/admin/ $ADMIN_DATA_REPO
