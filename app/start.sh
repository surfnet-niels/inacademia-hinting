...
CONFIG_PATH=/tmp/inacademia/config
...
# push upsteam
GIT_SSH_COMMAND='ssh -oStrictHostKeyChecking=no -i /tmp/inacademia/config/id_rsa_inacademia' /usr/bin/git push origin-ssh
...
GIT_SSH_COMMAND='ssh -i /tmp/inacademia/config/id_rsa_inacademia' /usr/bin/git clone $ADMIN_DATA_REPO /tmp/admin_data_repo/
cd /tmp/admin_data_repo/ 
GIT_SSH_COMMAND='ssh -i /tmp/inacademia/config/id_rsa_inacademia' /usr/bin/git remote add origin-ssh git@$ADMIN_DATA_REPO
...
cd /tmp/admin_data_repo/
GIT_SSH_COMMAND='ssh -i /tmp/inacademia/config/id_rsa_inacademia' /usr/bin/git add --all
GIT_SSH_COMMAND='ssh -i /tmp/inacademia/config/id_rsa_inacademia' /usr/bin/git commit -am "Updated entities $(date +'%F %T')"
GIT_SSH_COMMAND='ssh -oStrictHostKeyChecking=no -i /tmp/inacademia/config/id_rsa_inacademia' /usr/bin/git push 
